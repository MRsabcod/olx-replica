...
<div className='flex items-center gap-5 max-w-7xl pt-[1.6rem] pb-[1.6rem]  w-full ml-auto mr-auto'>
                    ...
                    <div className=''>
                        ...
                        <Link to='/cart' className='flex'><IoCartOutline size={40} />
                ...
                <nav className='flex items-center gap-5 max-w-7xl pt-[1.6rem] pb-[1.6rem] justify-evenly w-full ml-auto mr-auto'>
                    ...
                    <div>
                        {userdetails === null ? <Link to='/login' className='text-black border-b-2 hover:border-b-transparent border-b-black border-solid' ><span onClick={() => { }}>LOGIN</span></Link> : userdetails != null ? <Link to='/login'>{userdetails?.fullname}</Link> : <div>Loading</div>}
                    </div>
                    <div>
