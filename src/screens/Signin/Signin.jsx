...
// console.log(email)
  return (
    <div className='h-[35rem]'>
      {/* {user} */}
        <form className='flex flex-col justify-center gap-3 p-10 w-[28rem] h-[30rem] absolute top-[76%] left-1/2  -translate-x-1/2 -translate-y-1/2  border-black border-solid border-2 '>
