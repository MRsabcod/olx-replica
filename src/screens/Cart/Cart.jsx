  ...
  return (
    <div className='flex gap-2'>
       ...
       return <div className=' rounded-[0.4rem]  overflow-hidden   w-[15vw] h-[66vh] border-[0.1rem] border-solid border-[#002f3433] m-10'>
           ...
           <div className='mt-4'>
                                <button onClick={()=>{deleteitem(prod)}} className='flex items-center justify-center m-auto  gap-2 font-bold p-3 rounded-md text-white bg-[#002f34]'> Delete item</button>
                            </div>
